...
export const propertyDetailsFields = {
  ...
  "Land": [
    { name: "plotArea", label: "Plot Area", type: "text", required: true, onInput: (e) => e.target.value = e.target.value.replace(/[^0-9]/g, ''), validation: { message: "Only numbers are allowed." } },
    { name: "areaUnitForPlot", label: "Area Unit", type: "select", options: ['sq.ft', 'sq.yards', 'sq.m.', 'acres', 'marla', 'cents', 'bigha', 'kottah', 'kanal', 'grounds', 'ares', 'biswa', 'guntha', 'aankadam', 'hectares', 'rood', 'chataks', 'perch'], required: true },
    { name: "lengthOfPlot", label: "Length of Plot", type: "text", required: false, onInput: (e) => e.target.value = e.target.value.replace(/[^0-9]/g, ''), validation: { message: "Only numbers are allowed." } },
    { name: "breadthOfPlot", label: "Breadth of Plot", type: "text", required: false, onInput: (e) => e.target.value = e.target.value.replace(/[^0-9]/g, ''), validation: { message: "Only numbers are allowed." } },
    ...
    { name: "constructionDone", label: "Construction Done", type: "checkbox", required: true },
  ...
  "Retail": [
    ...
    { name: "plotArea", label: "Plot Area", type: "text", required: true, onInput: (e) => e.target.value = e.target.value.replace(/[^0-9]/g, ''), validation: { message: "Only numbers are allowed." } },
    { name: "builtUpArea", label: "Built-Up Area", type: "text", onInput: (e) => e.target.value = e.target.value.replace(/[^0-9]/g, ''), validation: { message: "Only numbers are allowed." } },
    { name: "areaUnitForCarpet", label: "Area Unit for Carpet", type: "select", options: ['sq.ft', 'sq.yards', 'sq.m.', 'acres', 'marla', 'cents', 'bigha', 'kottah', 'kanal', 'grounds', 'ares', 'biswa', 'guntha', 'aankadam', 'hectares', 'rood', 'chataks', 'perch'] },
    { name: "areaUnitForPlot", label: "Area Unit for Plot", type: "select", options: ['sq.ft', 'sq.yards', 'sq.m.', 'acres', 'marla', 'cents', 'bigha', 'kottah', 'kanal', 'grounds', 'ares', 'biswa', 'guntha', 'aankadam', 'hectares', 'rood', 'chataks', 'perch'], required: true },
    { name: "areaUnitForBuiltUp", label: "Area Unit for Built-Up", type: "select", options: ['sq.ft', 'sq.yards', 'sq.m.', 'acres', 'marla', 'cents', 'bigha', 'kottah', 'kanal', 'grounds', 'ares', 'biswa', 'guntha', 'aankadam', 'hectares', 'rood', 'chataks', 'perch'] },
