...
import { FiMapPin, FiHome, FiCalendar, FiUsers } from 'react-icons/fi';

const ProjectProfileLoader = () => {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-10 mt-12">
        <div className="md:col-span-2 space-y-8">
          ...
          {/* Project Details Section Loader */}
...
export default ProjectProfileLoader;